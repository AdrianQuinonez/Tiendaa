            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/products/create" class="float-end btn btn-success btn-sm float-right">Nuevo producto</a>
                    </div>
                    <div class="card-body">
                        @if(session('info'))
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-{{ $product->id }}" action="{{route('product.destry', $product->id)}}" method="POST">
                                            @method('delete')
                                            @csrf
                                        </form>
                                    </td>
